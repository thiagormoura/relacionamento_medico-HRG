...
function dadosProf($id, $conn) {
    $dados = array();
    $dados['assuntonome'] = array(); // Inicializa o array de assuntonomes
    ...
    $sql = "SELECT a.data AS data_atendimento, a.situacao AS situacao_atendimento, a.assunto, a.descricao, a.acoes, a.veiculo_atendimento,
            ...
            INNER JOIN atendimento_has_assunto rela ON a.id = rela.atendimento
            INNER JOIN assunto ass ON ass.id = rela.assunto
            WHERE a.id = $id";
    ...
    if ($result === false) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            $dados['assuntonome'][] = $row['assuntonome']; // Adiciona o assunto ao array
        }
    } else {
                    ...
                    <div class="border p-3">
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6 mt-2">
                                ...
                                <input type="text" class="form-control bg-muted" id="cpf" name="cpf" disabled value="<?= isset($dados['cpf_profissional']) ? htmlspecialchars($dados['cpf_profissional']) : "" ?>">
                            </div>
                            ...
                            <div class="col-xl-4 col-md-6 mt-2">
                                ...
                                <input type="text" class="form-control bg-muted" id="endereco" name="endereco" required readonly value="<?= isset($dados['endereco_profissional']) ? htmlspecialchars($dados['endereco_profissional']) : "" ?>">
                            </div>
                            <div class="row">
                                <div class="col-xl-3 col-md-6 mt-2">
                                ...
                                <div class="col-xl-3 col-md-6 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control bg-muted" id="orgao" name="orgao" maxlength="6" required readonly value="<?= isset($dados['orgao_profissional']) ? htmlspecialchars($dados['orgao_profissional']) : "" ?>">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="border p-3 mt-4">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-md-6 mt-3">
                            ...
                            <textarea class="form-control bg-muted custom-textarea2" id="assuntoatendimento" name="assunto atendimento" rows="1" maxlength="1000" readonly><?= isset($dados['assunto']) ? htmlspecialchars($dados['assunto']) : "" ?></textarea>
                        </div>
                        <div class="row">
                            <div class="col-xl-12 col-md-6 mt-3">
