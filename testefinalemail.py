import imaplib  
# Módulo que fornece uma interface para comunicação com servidores de e-mail usando o protocolo IMAP 
import email
# Módulo que facilita a criação, manipulação e envio de mensagens de e-mail em Python
from email.header import decode_header
# Função do módulo email.header que é usada para decodificar cabeçalhos de e-mail que podem estar codificados em diferentes conjuntos de caracteres
